...
KERNEL_BOOTIMAGE_CMDLINE = androidboot.hardware=qcom androidboot.memcg=1 lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 service_locator.enable=1 androidboot.usbcontroller=a600000.dwc3 swiotlb=2048 loop.max_part=7 cgroup.memory=nokmem,nosocket reboot=panic_warm buildproduct=pdx206_kddi buildid=EDO-2.1.1-KDDI-220224-1338 oemboot.earlymount=/dev/block/platform/soc/1d84000.ufshc/by-name/oem:/mnt/oem:ext4:ro,barrier=1:wait,slotselect,first_stage_mount
...
# Defconfig to use
KERNEL_DEFCONFIG = vendor/pdx206_defconfig
...
# will be made.
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/qcom/kona.dtb arch/arm64/boot/dts/qcom/kona-v2.dtb arch/arm64/boot/dts/qcom/kona-v2.1.dtb
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/somc/kona-edo-pdx206_generic-overlay.dtbo
